...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("hiring_prosses_pk");
        ...
        {
            entity.HasKey(e => e.Id).HasName("material_association_pk");
        ...
        modelBuilder.Entity<PotOtdel>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                .ValueGeneratedNever()
                .HasColumnName("ID");
            entity.Property(e => e.IdStructal).HasColumnName("ID_Structal");
            entity.Property(e => e.Name).HasColumnType("character varying");

            entity.HasOne(d => d.IdStructalNavigation).WithMany(p => p.PotOtdels)
                .HasForeignKey(d => d.IdStructal)
                .HasConstraintName("pototdel_structural_separation_fk");
        });
        ...
        modelBuilder.Entity<StructuralSeparation>(entity =>
        {
            ...
            entity.HasOne(d => d.HeadOfDepartmentNavigation).WithMany(p => p.StructuralSeparations)
        ...
        modelBuilder.Entity<Subdivision>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Subdivisions", "public_31-01-2025");
            ...
            entity.HasOne(d => d.StructuralSeparation).WithMany()
        ...
        {
            entity.HasKey(e => e.Id).HasName("traning_attendance_pk");
